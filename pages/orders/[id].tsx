...
import { Grid, Typography, Card, CardContent, Divider, Box, Chip, CircularProgress } from '@mui/material';
...
const OrderPage: NextPage<Props> = ({ order }) => {
	...
	const { _id, isPaid, numberOfItems, orderItems, subTotal, tax, total, shippingAddress } = order;
	...
	return (
		<ShopLayout title="Resumen de orden" pageDescription="Resumen de la orden">
			<Typography variant="h1" component="h1" mb={ 2}>Orden: { _id }</Typography>
